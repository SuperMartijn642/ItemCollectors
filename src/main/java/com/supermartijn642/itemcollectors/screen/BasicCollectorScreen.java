...
public class BasicCollectorScreen extends BlockEntityBaseWidget<CollectorBlockEntity> {
    ...
    protected void render(WidgetRenderContext context, int mouseX, int mouseY, CollectorBlockEntity entity){
        ...
        ScreenUtils.drawCenteredString(context.poseStack(), TextComponents.number(entity.getRangeX()).get(), 39, 52);
        ScreenUtils.drawCenteredString(context.poseStack(), TextComponents.string("y:").get(), 68, 51);
        ScreenUtils.drawCenteredString(context.poseStack(), TextComponents.number(entity.getRangeY()).get(), 82, 52);
        ScreenUtils.drawCenteredString(context.poseStack(), TextComponents.string("z:").get(), 111, 51);
        ScreenUtils.drawCenteredString(context.poseStack(), TextComponents.number(entity.getRangeZ()).get(), 125, 52);
